...
const posts = [
  {
    ...
    excerpt:
      "介绍 Prompt 管理器增强计划，以及写作助手、代码生成模块的里程碑。",
    date: "2026-03-16",
    tag: "产品更新",
  },
  {
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        {posts.map((post) => (
          ...
          >
            ...
            <button
              className="mt-5 inline-flex rounded-md border border-border px-3 py-1.5 text-sm text-muted-foreground hover:bg-accent hover:text-accent-foreground"
              type="button"
            >
              阅读详情（即将上线）
            </button>
